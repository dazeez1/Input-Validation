...
#ifndef INPUT_VALIDATION_SWIFT_H
#define INPUT_VALIDATION_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="input_validation",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC16input_validation11AppDelegate")
...
SWIFT_CLASS("_TtC16input_validation17MainFlutterWindow")
